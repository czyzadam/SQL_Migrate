...
DB_FAILOVER = OFF,
DTC_SUPPORT = NONE)
FOR DATABASE [AdventureWorksLT2016]
REPLICA ON N'WINSRV01\INSTA1' WITH (ENDPOINT_URL = N'TCP://WINSRV01.adam.local:5022', FAILOVER_MODE = MANUAL, AVAILABILITY_MODE = ASYNCHRONOUS_COMMIT, BACKUP_PRIORITY = 50, SEEDING_MODE = AUTOMATIC, SECONDARY_ROLE(ALLOW_CONNECTIONS = NO)),
	N'WINSRV02\INSTA1' WITH (ENDPOINT_URL = N'TCP://WINSRV02.adam.local:5022', FAILOVER_MODE = MANUAL, AVAILABILITY_MODE = ASYNCHRONOUS_COMMIT, BACKUP_PRIORITY = 50, SEEDING_MODE = AUTOMATIC, SECONDARY_ROLE(ALLOW_CONNECTIONS = NO));
...
WITH IP
((N'192.168.0.201', N'255.255.255.0')
)
, PORT=1433);
